...
// PlainService contains methods and other services that help with interacting with
// the mockhttp API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewPlainService] method instead.
type PlainService struct {
	Options []option.RequestOption
}

// NewPlainService generates a new service that applies the given options to each
