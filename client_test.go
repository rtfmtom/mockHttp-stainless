...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Get.RequestInfo(context.Background())
	if userAgent != fmt.Sprintf("Mockhttp/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Get.RequestInfo(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Get.RequestInfo(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Get.RequestInfo(deadlineCtx)
		if err == nil {
