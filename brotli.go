...
// BrotliService contains methods and other services that help with interacting
// with the mockhttp API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewBrotliService] method instead.
type BrotliService struct {
	Options []option.RequestOption
}

// NewBrotliService generates a new service that applies the given options to each
