...
import (
	...
	"github.com/rtfmtom/mockHttp-stainless/internal/apiform"
	"github.com/rtfmtom/mockHttp-stainless/internal/apiquery"
)

func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("Mockhttp/Go %s", internal.PackageVersion),
	}
}
