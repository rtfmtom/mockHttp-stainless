...
func TestStatusNew(t *testing.T) {
	...
	_, err := client.Status.New(context.TODO(), "code")
	if err != nil {
...
func TestStatusGet(t *testing.T) {
	...
	_, err := client.Status.Get(context.TODO(), "code")
	if err != nil {
		var apierr *mockhttp.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestStatusUpdate(t *testing.T) {
	...
	_, err := client.Status.Update(context.TODO(), "code")
	if err != nil {
		var apierr *mockhttp.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestStatusDelete(t *testing.T) {
	...
	_, err := client.Status.Delete(context.TODO(), "code")
	if err != nil {
		var apierr *mockhttp.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestStatusPatch(t *testing.T) {
	...
	_, err := client.Status.Patch(context.TODO(), "code")
	if err != nil {
		var apierr *mockhttp.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
