...
func TestPlainNew(t *testing.T) {
	...
	_, err := client.Plain.New(context.TODO())
	if err != nil {
...
func TestPlainGet(t *testing.T) {
	...
	_, err := client.Plain.Get(context.TODO())
	if err != nil {
		var apierr *mockhttp.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestPlainUpdate(t *testing.T) {
	...
	_, err := client.Plain.Update(context.TODO())
	if err != nil {
		var apierr *mockhttp.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestPlainDelete(t *testing.T) {
	...
	_, err := client.Plain.Delete(context.TODO())
	if err != nil {
		var apierr *mockhttp.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestPlainModify(t *testing.T) {
	...
	_, err := client.Plain.Modify(context.TODO())
	if err != nil {
		var apierr *mockhttp.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
